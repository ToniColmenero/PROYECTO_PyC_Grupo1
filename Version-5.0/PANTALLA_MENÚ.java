...
{
    //public static GreenfootSound Inicio= new GreenfootSound("inicio2.mp3");
    
    static public float dificultad=1;
    public static int jugadores=1;
    static public int volumen=50;
    ...
    {    
        ...
        addObject(new solo(), 50, 430);
        addObject(new duo(), 120, 430);
        addObject(new trio(), 80, 510);
    }
    public void act()
    {
